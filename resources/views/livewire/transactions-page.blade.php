    ...
    @if($showForm)
        <div class="fixed inset-0 z-10 overflow-y-auto bg-slate-950/40 p-4"><div class="mx-auto my-8 max-w-2xl rounded-3xl bg-white p-6 shadow-xl">
            ...
            <form wire:submit="save" class="grid gap-4 md:grid-cols-2">
                <label class="field">Tipo<select wire:model="form.type"><option value="expense">Saída</option><option value="income">Entrada</option></select></label><label class="field">Valor<input wire:model="form.amount" type="number" step="0.01" placeholder="0,00"></label><label class="field md:col-span-2">Descrição<input wire:model="form.description" placeholder="Ex.: Mercado da semana"></label><label class="field">Loja / pagador<input wire:model="form.merchant"></label><label class="field">Data da compra/competência<input wire:model="form.due_date" type="date"></label>
