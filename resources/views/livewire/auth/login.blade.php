    ...
    <section class="auth-card">
        <div class="auth-form-pane">
            ...
            <form wire:submit="login" class="auth-form">
                <label class="auth-field">E-mail<input wire:model.live="email" type="email" name="email" autocomplete="email" autofocus placeholder="voce@exemplo.com" @error('email') aria-invalid="true" @enderror></label>
                <label class="auth-field">Senha<input wire:model.live="password" type="password" name="password" autocomplete="current-password" placeholder="Digite sua senha" @error('password') aria-invalid="true" @enderror></label>
