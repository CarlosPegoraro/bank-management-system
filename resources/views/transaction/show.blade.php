        ...
        <div class="col-12 col-sm-4 p-5">
            ...
            <div class="row mt-4">
                <div class="col-12 col-sm-6">
                    <p class="text-dark">{{ __('Store') .':' }} <span class="fw-bold text-primary">{{ $transaction->store }}</span></p>
                </div>
                <div class="col-12 col-sm-6">
                    <p class="text-dark">{{ __('Bought Date') .':' }} <span class="fw-bold text-primary">{{ \Carbon\Carbon::parse($transaction->date)->format('d/m/Y') }}</span></p>
                </div>
                <div class="col-12 col-sm-6">
                    <p class="text-dark">{{ __('Due Date') .':' }} <span class="fw-bold text-primary">{{ \Carbon\Carbon::parse($transaction->finnally)->format('d/m/Y') }}</span></p>
                </div>
                <div class="col-12 col-sm-6">
                    <p class="text-dark">{{ __('Total Amount') .':' }} <span class="fw-bold text-primary" id="formattedTotalAmount"></span></p>
                </div>
                <div class="col-12 col-sm-6">
                    <p class="text-dark">{{ __('Installments') .':' }} <span class="fw-bold text-primary">{{ $transaction->installments }}</span></p>
                </div>
                <div class="col-12 col-sm-6">
                    <p class="text-dark">{{ __('Installment Value') .':' }} <span class="fw-bold text-primary" id="formattedMensal"></span></p>
                </div>
                <div class="col-12 col-sm-6">
                    <p class="text-dark">{{ __('Description') .':' }} <span class="fw-bold text-primary">{{ $transaction->description }}</span></p>
                </div>
            </div>
        </div>
